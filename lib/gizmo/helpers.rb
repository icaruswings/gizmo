module Gizmo
  ...
  module Helpers
    ...
    def on_page &block
      raise NilResponseError, "Doh! response object is nil. This generally means your scenario has not yet visited a page!" if source.nil?
      yield Page.new(self, source, current_url)
    end
